pub use gdnative_core::core_types::{
    ...
    Rotation2D, Rotation3D, Size2, StringArray, StringName, Transform, Transform2D, Variant,
    VariantArray, VariantOperator, VariantType, Vector2, Vector2Array, Vector3, Vector3Array,
};
pub use gdnative_core::core_types::{
