...
//! implement [`NewRef`] which provides a `new_ref(&self) -> Self` method to create references
//! to the same collection or object.
//!
//! ## Generated API types
//!
...
//!
//! [`Dictionary`]: core_types/struct.Dictionary.html
//! [`ManuallyManaged`]: ref_kind/struct.ManuallyManaged.html
//! [`NewRef`]: trait.NewRef.html
//! [`RefCounted`]: ref_kind/struct.RefCounted.html
//! [`Ref`]: struct.Ref.html
//! [`TRef`]: struct.TRef.html
//! [`VariantArray`]: core_types/struct.VariantArray.html
//! [`api`]: api/index.html
//!
...
///
/// See the [top module documentation](../index.html#generated-api-types) for more information.
